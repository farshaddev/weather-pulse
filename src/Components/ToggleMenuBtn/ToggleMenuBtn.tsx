...
const ToggleMenuBtn: React.FC = () => {
	...
	const basicToggleMenuLineClasses =
		"block h-0.5 w-full rounded-full bg-slate-100 transition-all duration-100";
	...
	return (
		<button
			...
			onClick={toggleMenu}
			className={
				"flex w-8 cursor-pointer flex-col justify-center gap-1 rounded-md border-0 bg-slate-600 p-2"
			}
		>
